define('app',['exports', 'aurelia-framework', 'api/user', 'cache/user'], function (exports, _aureliaFramework, _user, _user2) {
  'use strict';
  ...
  var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_user.UserApi, _user2.UserCache), _dec(_class = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: ['', 'welcome'], name: 'welcome', moduleId: 'welcome', nav: true, title: 'Welcome' }, { route: 'apiTest', name: 'apiTest', moduleId: 'apiTests/apiTests', nav: true, title: 'API Tests' }, { route: 'admin', name: 'admin', moduleId: 'admin/admin', nav: this.user.admin, title: 'Admin Portal' }]);
...
define('admin/admin',['exports', 'aurelia-framework', 'cache/user'], function (exports, _aureliaFramework, _user) {
    ...
    var AdminPortal = exports.AdminPortal = (_dec = (0, _aureliaFramework.inject)(_user.UserCache), _dec(_class = function AdminPortal(userCache) {
