...
define('resources/elements/nav-bar',['exports'], function (exports) {
  'use strict';
  ...
  var NavBarCustomElement = exports.NavBarCustomElement = function NavBarCustomElement() {
...
define('text!app.html', ['module'], function(module) { module.exports = "<template>\n  <!--<require from='./resources/elements/nav-bar'>\n\n  <nav-bar></nav-bar>-->\n  <h1>Hello World</h1>\n\n  <div class=\"page-host\">\n    <router-view></router-view>\n  </div>\n</template>\n"; });
